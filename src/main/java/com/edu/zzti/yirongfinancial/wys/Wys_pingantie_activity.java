...
public class Wys_pingantie_activity extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.wys_pingantie_activity);
	}
	public void pinganback(View v){
		finish();

	}

	
	public void click_pingandianhua(View v){
